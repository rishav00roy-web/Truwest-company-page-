  ...
  return (
    <>
      ...
      <section className="bg-white py-[110px]" id="documents">
        <div className="max-w-[1140px] mx-auto px-6 border-t border-line pt-[100px]">
          ...
          <div className="border-t border-line">
            {[
              { q: 'Business bank statements', a: 'Typically 6 to 12 months showing revenue or cash flow evidence and consistent deposits.' },
              { q: 'T1 Generals', a: 'Your two most recent years with all schedules attached.' },
              { q: 'Notices of Assessment (NOAs)', a: 'Matching your two tax years, confirming your filings are up to date and taxes are paid.' },
              { q: 'Corporate financial statements', a: 'Accountant-prepared financials including balance sheet, income statement, retained earnings, and articles of incorporation.' },
              { q: 'Supporting documents', a: 'Photo ID, down payment confirmation, existing mortgage statements, rental agreements, or major contracts and invoices.' }
            ].map((item, idx) => (
              <details key={idx} className="group border-b border-line [&_summary::-webkit-details-marker]:hidden">
                ...
                <div className="pb-[32px] font-sans text-[16px] text-stone leading-[1.65] max-w-[800px]">
                  {item.a}
                </div>
              </details>
            ))}
          </div>
          <p className="font-sans text-[12.5px] tracking-[0.02em] text-stone max-w-[780px] leading-[1.75] mt-[48px] uppercase">Note: This is a general guide. Do not submit confidential financial documents through our web forms.</p>
        </div>
      </section>
      ...
      <FaqSection 
        ...
        items={[
          {
            question: "Can I get a mortgage in BC if I write off most of my income?",
          ...
          {
            question: "What documents should self-employed borrowers in Surrey have ready?",
